    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('video', 'Video'), ('short', 'Short'), ('ebook', 'Ebook'), ('html', 'HTML'), ('pdf', 'PDF'), ('live', 'Live')], max_length=30, verbose_name='Format')),
                ('duration', models.DurationField(verbose_name='Duration')),
                ('license', models.CharField(blank=True, default='', max_length=255, verbose_name='License')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='media_quizzes', to='content.media', verbose_name='Media')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.quiz', verbose_name='Quiz')),
            ],
            options={
                'verbose_name': 'Media Quiz',
                'verbose_name_plural': 'Media Quizzes',
            },
        ),
        migrations.AddField(
            model_name='media',
            name='quizzes',
            field=models.ManyToManyField(blank=True, through='content.MediaQuiz', to='quiz.quiz', verbose_name='Quizzes'),
        ),
        migrations.CreateModel(
            name='MediaQuizEvent',
            fields=[
                ...
                ('pgh_context', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='pghistory.context')),
                ('pgh_obj', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='content.mediaquiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='public_access', to='content.media', verbose_name='Media')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subtitles', to='content.media', verbose_name='Media')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='mediaquiz',
            constraint=models.UniqueConstraint(fields=('media', 'quiz', 'lang'), name='content_media_quiz_me_qu_la_uniq'),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='mediaquiz',
            trigger=pgtrigger.compiler.Trigger(name='insert_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "content_mediaquizevent" ("id", "lang", "media_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "quiz_id") VALUES (NEW."id", NEW."lang", NEW."media_id", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."quiz_id"); RETURN NULL;', hash='0f868131d75f0ac62545ae6826c0be0c640587eb', operation='INSERT', pgid='pgtrigger_insert_insert_2405b', table='content_mediaquiz', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='mediaquiz',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)', func='INSERT INTO "content_mediaquizevent" ("id", "lang", "media_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "quiz_id") VALUES (NEW."id", NEW."lang", NEW."media_id", _pgh_attach_context(), NOW(), \'update\', NEW."id", NEW."quiz_id"); RETURN NULL;', hash='2b1b383ee802057eee2abdbba36b444d1d79b5b3', operation='UPDATE', pgid='pgtrigger_update_update_38f0f', table='content_mediaquiz', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='mediaquiz',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "content_mediaquizevent" ("id", "lang", "media_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "quiz_id") VALUES (OLD."id", OLD."lang", OLD."media_id", _pgh_attach_context(), NOW(), \'delete\', OLD."id", OLD."quiz_id"); RETURN NULL;', hash='5c85469104b2c0c085d318958f630d2e7c2dd133', operation='DELETE', pgid='pgtrigger_delete_delete_9d883', table='content_mediaquiz', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='media',
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='mediaquizevent',
            trigger=pgtrigger.compiler.Trigger(name='append_only', sql=pgtrigger.compiler.UpsertTriggerSql(func="RAISE EXCEPTION 'pgtrigger: Cannot update or delete rows from % table', TG_TABLE_NAME;", hash='a3010ff94d48f4d26872747fc74d460b6d0de813', operation='UPDATE OR DELETE', pgid='pgtrigger_append_only_edbc9', table='content_mediaquizevent', when='BEFORE')),
        ),
        migrations.AddConstraint(
            model_name='note',
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='watch',
            trigger=pgtrigger.compiler.Trigger(name='insert_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "content_watchevent" ("context", "created", "id", "media_id", "mode", "modified", "passed", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "rate", "user_id", "watch_bits") VALUES (NEW."context", NEW."created", NEW."id", NEW."media_id", NEW."mode", NEW."modified", NEW."passed", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."rate", NEW."user_id", NEW."watch_bits"); RETURN NULL;', hash='514cc9edca2f97e6479fdc1223332b0fa2c2929e', operation='INSERT', pgid='pgtrigger_insert_insert_ed900', table='content_watch', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='watch',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD."context" IS DISTINCT FROM (NEW."context") OR OLD."id" IS DISTINCT FROM (NEW."id") OR OLD."media_id" IS DISTINCT FROM (NEW."media_id") OR OLD."mode" IS DISTINCT FROM (NEW."mode") OR OLD."passed" IS DISTINCT FROM (NEW."passed") OR OLD."rate" IS DISTINCT FROM (NEW."rate") OR OLD."user_id" IS DISTINCT FROM (NEW."user_id") OR OLD."watch_bits" IS DISTINCT FROM (NEW."watch_bits"))', func='INSERT INTO "content_watchevent" ("context", "created", "id", "media_id", "mode", "modified", "passed", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "rate", "user_id", "watch_bits") VALUES (NEW."context", NEW."created", NEW."id", NEW."media_id", NEW."mode", NEW."modified", NEW."passed", _pgh_attach_context(), NOW(), \'update\', NEW."id", NEW."rate", NEW."user_id", NEW."watch_bits"); RETURN NULL;', hash='b4c2f4ceb34f21405f9ba5e1c9a64d1193da20b6', operation='UPDATE', pgid='pgtrigger_update_update_7cf93', table='content_watch', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='watch',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "content_watchevent" ("context", "created", "id", "media_id", "mode", "modified", "passed", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "rate", "user_id", "watch_bits") VALUES (OLD."context", OLD."created", OLD."id", OLD."media_id", OLD."mode", OLD."modified", OLD."passed", _pgh_attach_context(), NOW(), \'delete\', OLD."id", OLD."rate", OLD."user_id", OLD."watch_bits"); RETURN NULL;', hash='760ba879d902981c08a9276685221b802a834f68', operation='DELETE', pgid='pgtrigger_delete_delete_38707', table='content_watch', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
