    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(blank=True, db_index=True, default='', max_length=500, verbose_name='Path')),
        ...
        migrations.AddIndex(
            model_name='appeal',
            index=models.Index(fields=['question_type', 'question_id'], name='operation_a_questio_0c69e6_idx'),
        ),
        migrations.AddConstraint(
            model_name='appeal',
