    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('writer', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Writer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('read', models.DateTimeField(auto_now_add=True, verbose_name='Read at')),
                ('announcement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reads', to='operation.announcement', verbose_name='Announcement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_id', models.CharField(max_length=12, verbose_name='Assessment ID')),
                ('question_id', models.IntegerField(verbose_name='Question ID')),
                ('assessment_type', models.ForeignKey(limit_choices_to={'model__in': ['exam', 'assignment', 'discussion']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='Assessment Type')),
                ...
                ('reviewer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Reviewer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_id', models.CharField(max_length=12, verbose_name='Assessment ID')),
                ('question_id', models.IntegerField(verbose_name='Question ID')),
                ('assessment_type', models.ForeignKey(db_constraint=False, limit_choices_to={'model__in': ['exam', 'assignment', 'discussion']}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='contenttypes.contenttype', verbose_name='Assessment Type')),
                ...
                ('reviewer', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Reviewer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddIndex(
            model_name='appeal',
            index=models.Index(fields=['assessment_type', 'assessment_id', 'question_id'], name='operation_a_assessm_f4b161_idx'),
        ),
        migrations.AddConstraint(
            model_name='appeal',
            constraint=models.UniqueConstraint(fields=('assessment_type', 'assessment_id', 'learner', 'question_id'), name='operation_appeal_asty_asid_le_quid_uniq'),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='appeal',
            trigger=pgtrigger.compiler.Trigger(name='insert_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "operation_appealevent" ("assessment_id", "assessment_type_id", "created", "explanation", "id", "learner_id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id", "review", "reviewer_id") VALUES (NEW."assessment_id", NEW."assessment_type_id", NEW."created", NEW."explanation", NEW."id", NEW."learner_id", NEW."modified", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."question_id", NEW."review", NEW."reviewer_id"); RETURN NULL;', hash='124ac788c273ff2937f5f1dc9c17516b80cde65a', operation='INSERT', pgid='pgtrigger_insert_insert_c7b97', table='operation_appeal', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='appeal',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD."assessment_id" IS DISTINCT FROM (NEW."assessment_id") OR OLD."assessment_type_id" IS DISTINCT FROM (NEW."assessment_type_id") OR OLD."explanation" IS DISTINCT FROM (NEW."explanation") OR OLD."id" IS DISTINCT FROM (NEW."id") OR OLD."learner_id" IS DISTINCT FROM (NEW."learner_id") OR OLD."question_id" IS DISTINCT FROM (NEW."question_id") OR OLD."review" IS DISTINCT FROM (NEW."review") OR OLD."reviewer_id" IS DISTINCT FROM (NEW."reviewer_id"))', func='INSERT INTO "operation_appealevent" ("assessment_id", "assessment_type_id", "created", "explanation", "id", "learner_id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id", "review", "reviewer_id") VALUES (NEW."assessment_id", NEW."assessment_type_id", NEW."created", NEW."explanation", NEW."id", NEW."learner_id", NEW."modified", _pgh_attach_context(), NOW(), \'update\', NEW."id", NEW."question_id", NEW."review", NEW."reviewer_id"); RETURN NULL;', hash='3cdf0efac9e5e96785bc6da9d7a22741e015f5cd', operation='UPDATE', pgid='pgtrigger_update_update_3fe73', table='operation_appeal', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='appeal',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "operation_appealevent" ("assessment_id", "assessment_type_id", "created", "explanation", "id", "learner_id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id", "review", "reviewer_id") VALUES (OLD."assessment_id", OLD."assessment_type_id", OLD."created", OLD."explanation", OLD."id", OLD."learner_id", OLD."modified", _pgh_attach_context(), NOW(), \'delete\', OLD."id", OLD."question_id", OLD."review", OLD."reviewer_id"); RETURN NULL;', hash='d0e260a83f5494df6a1af3aa40693e6c8bcfba9b', operation='DELETE', pgid='pgtrigger_delete_delete_1853c', table='operation_appeal', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='announcement',
            trigger=pgtrigger.compiler.Trigger(name='insert_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "operation_announcementevent" ("body", "created", "id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pinned", "public", "title", "writer_id") VALUES (NEW."body", NEW."created", NEW."id", NEW."modified", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."pinned", NEW."public", NEW."title", NEW."writer_id"); RETURN NULL;', hash='5bba62c07c32e921dc00306afe051d1fe6b9c633', operation='INSERT', pgid='pgtrigger_insert_insert_85a14', table='operation_announcement', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='announcement',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD."body" IS DISTINCT FROM (NEW."body") OR OLD."id" IS DISTINCT FROM (NEW."id") OR OLD."pinned" IS DISTINCT FROM (NEW."pinned") OR OLD."public" IS DISTINCT FROM (NEW."public") OR OLD."title" IS DISTINCT FROM (NEW."title") OR OLD."writer_id" IS DISTINCT FROM (NEW."writer_id"))', func='INSERT INTO "operation_announcementevent" ("body", "created", "id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pinned", "public", "title", "writer_id") VALUES (NEW."body", NEW."created", NEW."id", NEW."modified", _pgh_attach_context(), NOW(), \'update\', NEW."id", NEW."pinned", NEW."public", NEW."title", NEW."writer_id"); RETURN NULL;', hash='2a59408fa93524d47f2586142ede3d77f7f6a5bd', operation='UPDATE', pgid='pgtrigger_update_update_bd3f3', table='operation_announcement', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='announcement',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "operation_announcementevent" ("body", "created", "id", "modified", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pinned", "public", "title", "writer_id") VALUES (OLD."body", OLD."created", OLD."id", OLD."modified", _pgh_attach_context(), NOW(), \'delete\', OLD."id", OLD."pinned", OLD."public", OLD."title", OLD."writer_id"); RETURN NULL;', hash='17cb3c903686aaecb8567a67bad699d21482f49c', operation='DELETE', pgid='pgtrigger_delete_delete_34cc9', table='operation_announcement', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
