    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closed', models.DateTimeField(blank=True, null=True, verbose_name='Closed')),
        ...
        migrations.AddField(
            model_name='announcementevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='operation.announcement'),
        ),
        migrations.AddField(
            model_name='announcementread',
            name='announcement',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operation.announcement', verbose_name='Announcement'),
        ),
        migrations.AddField(
            model_name='announcementread',
            name='user',
        ...
        migrations.AddField(
            ...
            name='announcement',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='operation.announcement', verbose_name='Announcement'),
        ),
        migrations.AddField(
            model_name='announcementreadevent',
            name='pgh_context',
        ...
        migrations.AddField(
            model_name='announcementreadevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='operation.announcementread'),
        ),
        migrations.AddField(
            model_name='announcementreadevent',
            name='user',
        ...
        migrations.AddField(
            model_name='appeal',
            name='learner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Learner'),
        ),
        migrations.AddField(
            model_name='appeal',
            name='question_type',
            field=models.ForeignKey(limit_choices_to={'model__in': ['question']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='Question Type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='appealevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='operation.appeal'),
        ),
        migrations.AddField(
            model_name='appealevent',
            name='question_type',
            field=models.ForeignKey(db_constraint=False, limit_choices_to={'model__in': ['question']}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='contenttypes.contenttype', verbose_name='Question Type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attachmentevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='operation.attachment'),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='category',
        ...
        migrations.AddField(
            model_name='faqitem',
            name='faq',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='operation.faq', verbose_name='FAQ'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='inquiry',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inquiry_responses', to='operation.inquiry', verbose_name='Inquiry'),
        ),
        migrations.AddField(
            model_name='inquiryresponse',
            name='writer',
        ...
        migrations.AddField(
            model_name='notificationdeviceevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='operation.notificationdevice'),
        ),
        migrations.AddField(
            model_name='notificationdeviceevent',
            name='user',
        ...
        migrations.AddField(
            ...
            name='policy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_versions', to='operation.policy', verbose_name='Policy'),
        ),
        migrations.AddField(
            model_name='policyagreementevent',
            name='version',
