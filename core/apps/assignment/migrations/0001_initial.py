...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='pool',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='assignment.questionpool', verbose_name='Question Pool'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='rubric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rubric_criteria', to='assignment.rubric', verbose_name='Rubric'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='criterion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performance_levels', to='assignment.rubriccriterion', verbose_name='Criterion'),
        ),
        migrations.AddField(
