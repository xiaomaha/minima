    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_attachment', models.FileField(blank=True, max_length=255, null=True, upload_to='', verbose_name='Sample Attachment')),
        ...
        migrations.AddField(
            model_name='attempt',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assignment.question', verbose_name='Question'),
        ),
        migrations.CreateModel(
            name='QuestionPool',
            fields=[
