...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='pool',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='exam.questionpool', verbose_name='Question Pool'),
        ),
        migrations.CreateModel(
            name='ExamEvent',
            fields=[
