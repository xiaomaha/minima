...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='solution',
            trigger=pgtrigger.compiler.Trigger(name='insert_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "exam_solutionevent" ("correct_answers", "correct_criteria", "explanation", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id") VALUES (NEW."correct_answers", NEW."correct_criteria", NEW."explanation", NEW."id", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."question_id"); RETURN NULL;', hash='5aff927ab0c88dc1adadb2d01101ec8f08c0a81d', operation='INSERT', pgid='pgtrigger_insert_insert_1c17b', table='exam_solution', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='solution',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)', func='INSERT INTO "exam_solutionevent" ("correct_answers", "correct_criteria", "explanation", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id") VALUES (NEW."correct_answers", NEW."correct_criteria", NEW."explanation", NEW."id", _pgh_attach_context(), NOW(), \'update\', NEW."id", NEW."question_id"); RETURN NULL;', hash='58c3c4643b153770b6301025cac4f2fd74c78f0e', operation='UPDATE', pgid='pgtrigger_update_update_7711c', table='exam_solution', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='solution',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "exam_solutionevent" ("correct_answers", "correct_criteria", "explanation", "id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "question_id") VALUES (OLD."correct_answers", OLD."correct_criteria", OLD."explanation", OLD."id", _pgh_attach_context(), NOW(), \'delete\', OLD."id", OLD."question_id"); RETURN NULL;', hash='86ca146dff7ba43945217de48bee818106cba10c', operation='DELETE', pgid='pgtrigger_delete_delete_b0805', table='exam_solution', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
