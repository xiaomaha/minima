    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faq', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='operation.faq', verbose_name='FAQ')),
                ('honor_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='operation.honorcode', verbose_name='Honor Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effort_hours', models.PositiveSmallIntegerField(verbose_name='Effort Hours')),
                ('level', models.CharField(choices=[('beginner', 'Beginner'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced'), ('common', 'Common')], max_length=20, verbose_name='Level')),
                ('faq', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='operation.faq', verbose_name='FAQ')),
                ('honor_code', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='operation.honorcode', verbose_name='Honor Code')),
