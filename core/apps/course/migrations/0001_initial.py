    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_offset', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='End Offset (Days) from Start Offset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, to='operation.category', verbose_name='Categories')),
                ('certificates', models.ManyToManyField(blank=True, to='competency.certificate', verbose_name='Certificates')),
                ('faq', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='operation.faq', verbose_name='FAQ')),
                ...
                ('related_courses', models.ManyToManyField(blank=True, to='course.course', verbose_name='Related Courses')),
            ],
            options={
                'verbose_name': 'Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmed', apps.common.models.BooleanField(blank=True, null=True, verbose_name='Confirmed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='course.course', verbose_name='Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_lesson', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='course.lesson', verbose_name='Last Lesson')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effort_hours', models.PositiveSmallIntegerField(verbose_name='Effort Hours')),
                ('level', models.CharField(choices=[('beginner', 'Beginner'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced'), ('common', 'Common')], max_length=20, verbose_name='Level')),
                ('faq', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='operation.faq', verbose_name='FAQ')),
