    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('claim', models.TextField(verbose_name='Claim')),
                ('endorsed', models.DateTimeField(verbose_name='Endorsed')),
                ('certificate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificate_endorsements', to='competency.certificate', verbose_name='Certificate')),
                ('partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='partner.partner', verbose_name='Partner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('coverage', models.FloatField(verbose_name='Coverage')),
                ('certificate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificate_skills', to='competency.certificate', verbose_name='Certificate')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='factor',
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factors', to='competency.skill', verbose_name='Skill'),
        ),
        migrations.AddField(
