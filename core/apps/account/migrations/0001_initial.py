    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.CharField(default='totp', max_length=50, verbose_name='Device Type')),
                ('consumer_id', models.CharField(max_length=36, verbose_name='Consumer ID')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='token',
            index=models.Index(fields=['token'], name='account_tok_token_55efc5_idx'),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='token',
