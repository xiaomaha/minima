 ...
 * Get Reactions
 */
export const accountV1GetReactions = <ThrowOnError extends boolean = true>(options?: Options<AccountV1GetReactionsData, ThrowOnError>) => (options?.client ?? client).get<AccountV1GetReactionsResponses, unknown, ThrowOnError>({ url: '/api/v1/account/reaction', ...options });

/**
 * Save Reaction
 */
export const accountV1SaveReaction = <ThrowOnError extends boolean = true>(options: Options<AccountV1SaveReactionData, ThrowOnError>) => (options.client ?? client).post<AccountV1SaveReactionResponses, unknown, ThrowOnError>({
