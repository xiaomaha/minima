...
const PostThread = (props: PostThreadProps) => {
  ...
  const pointRequirements = s().attempt!.question.pointRequirements
  const postBodyMinLength = pointRequirements.postMinCharacters!
  const replyBodyMinLength = pointRequirements.replyMinCharacters!
