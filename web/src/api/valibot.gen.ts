...
export const vAssignmentSchema = v.object({
    ...
    rubricData: v.nullable(vRubricSchema),
...
export const vDiscussionEarnedDetailsSchema = v.object({
    ...
    tutorAssessment: v.nullable(v.pipe(v.number(), v.integer()))
});
 ...
 * RubricCriterionSpec
 */
export const vRubricCriterionSpec = v.object({
    name: v.string(),
    description: v.string(),
    performanceLevels: v.array(vPerformanceLevelSchema)
});
...
export const vAssignmentSpec = v.object({
    ...
    id: v.string(),
    honorCodeId: v.pipe(v.number(), v.integer()),
    rubricCriteria: v.array(vRubricCriterionSpec),
 ...
 */
export const vAssignmentQuestionsSaveSpec = v.object({
    data: v.array(vAssignmentQuestionSaveSpec)
});

/**
 * RootModel[list[RubricCriterionSpec]]
 */
export const vRootModelListRubricCriterionSpec = v.array(vRubricCriterionSpec);
 ...
 * TutorContentSchema
 */
export const vTutorContentSchema = v.object({
    id: v.string(),
    created: v.pipe(v.string(), v.isoTimestamp()),
    title: v.string(),
    lastGrading: v.nullable(v.pipe(v.string(), v.isoTimestamp())),
    submissionCount: v.pipe(v.number(), v.integer()),
    gradeCompletedCount: v.pipe(v.number(), v.integer()),
    gradeConfirmedCount: v.pipe(v.number(), v.integer()),
    appealCount: v.pipe(v.number(), v.integer()),
    appealOpenCount: v.pipe(v.number(), v.integer())
});
 ...
 */
export const vPaginatedResponseAllocationSchema = v.object({
    items: v.array(vAllocationSchema),
    count: v.pipe(v.number(), v.integer()),
    size: v.pipe(v.number(), v.integer()),
    page: v.pipe(v.number(), v.integer()),
    pages: v.pipe(v.number(), v.integer())
 ...
 */
export const vAllocationStatsSchema = v.object({
    allocationCount: v.pipe(v.number(), v.integer()),
    submissionCount: v.pipe(v.number(), v.integer()),
    gradeCompletedCount: v.pipe(v.number(), v.integer()),
    gradeConfirmedCount: v.pipe(v.number(), v.integer()),
    appealCount: v.pipe(v.number(), v.integer()),
 ...
 */
export const vTutorExamGradeSchema = v.object({
    id: v.pipe(v.number(), v.integer()),
    created: v.pipe(v.string(), v.isoTimestamp()),
    score: v.number(),
    passed: v.boolean(),
 ...
 */
export const vPagedTutorExamGradeSchema = v.object({
    items: v.array(vTutorExamGradeSchema),
    count: v.pipe(v.number(), v.integer()),
    size: v.pipe(v.number(), v.integer()),
    page: v.pipe(v.number(), v.integer()),
    pages: v.pipe(v.number(), v.integer())
 ...
 */
export const vTutorExamQuestionSchema = v.object({
    id: v.pipe(v.number(), v.integer()),
    format: vExamQuestionFormatChoices,
    options: v.array(v.string()),
    question: v.string(),
    supplement: v.string(),
    point: v.pipe(v.number(), v.integer()),
    solution: v.nullable(vExamSolutionSchema)
});

/**
 * TutorExamGradePaperSchema
 */
export const vTutorExamGradePaperSchema = v.object({
    id: v.pipe(v.number(), v.integer()),
    earnedDetails: v.object({}),
    answers: v.record(v.string(), v.string()),
    feedback: v.record(v.string(), v.string()),
...
export const vStudioV1DeleteExamData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1DeleteQuizData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1DeleteSurveyData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1DeleteDiscussionData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1SaveDiscussionQuestionsData = v.object({
    body: v.object({
        files: v.optional(v.array(v.string())),
 ...
 * OK
 */
export const vStudioV1SaveDiscussionQuestionsResponse = v.array(v.pipe(v.number(), v.integer()));
...
export const vStudioV1DeleteAssignmentData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1SaveAssignmentData = v.object({
    body: v.object({
        thumbnail: v.optional(v.string()),
        sampleAttachment: v.optional(v.string()),
...
export const vStudioV1SaveAssignmentQuestionsData = v.object({
    body: v.object({
        files: v.optional(v.array(v.string())),
        data: vAssignmentQuestionsSaveSpec
    }),
    path: v.object({
        id: v.string()
    }),
 ...
 * OK
 */
export const vStudioV1SaveAssignmentQuestionsResponse = v.array(v.pipe(v.number(), v.integer()));
...
export const vStudioV1GetAssignmentRubricData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
 ...
 * OK
 */
export const vStudioV1GetAssignmentRubricResponse = v.array(vRubricCriterionSpec);

export const vStudioV1SaveAssignmentRubricData = v.object({
    body: vRootModelListRubricCriterionSpec,
    path: v.object({
        id: v.string()
    }),
    query: v.optional(v.never())
...
export const vStudioV1DeleteMediaData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vStudioV1DeleteCourseData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string()
    }),
...
export const vTutorV1GetAllocationData = v.object({
    body: v.optional(v.never()),
    path: v.optional(v.never()),
    query: v.optional(v.object({
        page: v.optional(v.pipe(v.number(), v.integer(), v.minValue(1)), 1),
 ...
 * OK
 */
export const vTutorV1GetAllocationResponse = vPaginatedResponseAllocationSchema;

export const vTutorV1GetAllocationStatsData = v.object({
    body: v.optional(v.never()),
    path: v.optional(v.never()),
    query: v.optional(v.never())
});
 ...
 * OK
 */
export const vTutorV1GetExamGradesResponse = vPagedTutorExamGradeSchema;

export const vTutorV1GetExamGradePaperData = v.object({
    body: v.optional(v.never()),
    path: v.object({
        id: v.string(),
