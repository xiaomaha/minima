 ...
 * Get Exam Appeals
 */
export const tutorV1GetExamAppeals = <ThrowOnError extends boolean = true>(options: Options<TutorV1GetExamAppealsData, ThrowOnError>) => (options.client ?? client).get<TutorV1GetExamAppealsResponses, unknown, ThrowOnError>({
    responseType: 'json',
 ...
 * Review Exam Appeals
 */
export const tutorV1ReviewExamAppeals = <ThrowOnError extends boolean = true>(options: Options<TutorV1ReviewExamAppealsData, ThrowOnError>) => (options.client ?? client).post<TutorV1ReviewExamAppealsResponses, unknown, ThrowOnError>({
    url: '/api/v1/tutor/exam/{id}/appeal',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Update Exam Question Solution
 */
export const tutorV1UpdateExamQuestionSolution = <ThrowOnError extends boolean = true>(options: Options<TutorV1UpdateExamQuestionSolutionData, ThrowOnError>) => (options.client ?? client).post<TutorV1UpdateExamQuestionSolutionResponses, unknown, ThrowOnError>({
